...
class UpdateAPI():
    def __init__(self, product_type):
        date_updated = requests.head(f'https://www.broadcom.com/support/security-center/definitions/download/detail?gid={product_type}').headers.get('Last-Modified').split(' ')[-2]
